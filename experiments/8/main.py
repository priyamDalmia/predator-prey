...
from trainers.train_coma import train_coma
...
config = dodict(dict(
        ...
        buffer_size=1500,
        # Models
        replay_dir="experiments/8/results/",
        checkpoint_dir="experiments/8/policies/",
        load_prey=False, 
        load_pred=False,
        # Log Control
        _name="f-1ac-1rand",
        ...
        project_name="experiment 8",
        log_level=10,
        log_file="experiments/8/runs.log",
        print_console=True,
        ))
...
if __name__=="__main__":
    ...
    job_id = ARGS.id
    with open('experiments/8/config.yaml') as f:
